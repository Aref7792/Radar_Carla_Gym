...
class CarlaEnv(gym.Env):
  ...
  def __init__(self, params):
    ...
    observation_space_dict = {
      ...
      'radar': spaces.Box(low=0, high=255, shape=(self.obs_size, self.obs_size, 4), dtype=np.uint8),
  ...
  def reset(self):
    ...
    self._clear_all_actors(['sensor.other.collision', 'sensor.lidar.ray_cast', 'sensor.other.radar', 'sensor.camera.rgb', 'vehicle.*', 'controller.ai.walker', 'walker.*'])
    ...
    # Add radar sensors (FRONT + LEFT + RIGHT)
