...
An OpenAI Gym-compatible environment for the CARLA simulator, designed for reinforcement learning in autonomous driving. This version is configured for CARLA 0.9.13 (updated from the original 0.9.6 setup).
